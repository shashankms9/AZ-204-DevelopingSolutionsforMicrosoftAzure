...
1. In the Azure portal, search and select **Storage account**, select the **imgstor[deployId]** storage account that you created earlier in this lab.

1.  From the **Storage Account** blade, in the **Data storage** section, select the **Containers** link,  

1. In the **Containers** blade, select the **images** container. In the images blade, select **Upload**.
