...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Review + create**.
   ...
   | **Resource group** section        | Select **Create new**, enter **MarketingContent**[DeploymentId], and then select **OK**. |
...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Docker**:
   ...
   | --------------------------------- | ------------------------------------------------------------ |
   | **Subscription** drop-down list   | Retain the default value.                                    |
   | **Resource group** drop-down list | Select **MarketingContent**[DeploymentId] in the list.                     |
   ...
   | **Linux Plan (East US)** section  | Select **Create new**. In the **Name** text box, enter **MarketingPlan**[DeploymentId], and then select **OK**. |
...
1. On the **Resource groups** blade, select the **MarketingContent**[DeploymentId] resource group that you created previously in this lab.

1. On the **MarketingContent**[DeploymentId] blade, select the **landingpage**_[DeploymentId]_ web app that you created previously in this lab.
...
1. On the **MarketingContent**[DeploymentId] blade, select the **contenthost**_[DeploymentId]_ storage account that you created previously in this lab.
...
1. On the **MarketingContent**[DeploymentId] blade, select the **contentdeliverynetwork** CDN profile that you created previously in this lab.
...
1. In the **Upload blob** pop-up window, perform the following actions:
    ...
    b.  In the **File Explorer** window, browse to **Allfiles (C):\\Allfiles\\Labs\\12\\Starter**, select the following files, and then select **Open**:
...
1. In the **Upload blob** pop-up window, perform the following actions:
    ...
    b.  In the **File Explorer** window, browse to **Allfiles (C):\\Allfiles\\Labs\\12\\Starter**, select the **welcome.mp4** file, and then select **Open**.
